...
INSERT INTO `roomsInfo` (`id`, `type`, `name`, `image`, `bedCount`, `price`, `price-br`) VALUES
(1, 'standard-1', 'Номер с большой кроватью (King Size)', 'img/2_rooms/s-1.jpg', 1, 340, 365),
(2, 'standard-2', 'Номер категории делюкс', 'img/2_rooms/s-2.jpg', 1, 375, 400),
(3, 'standard-3', 'Угловой номер категории делюкс с большой кроватью (king size) и панорамным видом', 'img/2_rooms/s-3.jpg', 1, 415, 440),
(4, 'standard-4', 'Номер с односпальной кроватью (Twin)', 'img/2_rooms/s-4.jpg', 1, 340, 365),
(5, 'standard-5', 'Номер с двумя односпальными кроватями (Twin)', 'img/2_rooms/s-5.jpg', 2, 340, 365),
(6, 'lux-1', 'Люкс с одной спальней, большой кроватью (King Size) и доступом в бар-гостиную', 'img/2_rooms/l-1.jpg', 1, 590, 615),
(7, 'lux-2', 'Президентский люкс с панорамным видом', 'img/2_rooms/l-2.jpg', 1, 4500, 4525),
(8, 'business-1', 'Номер бизнес-класса premium с большой кроватью (King Size)', 'img/2_rooms/bz-1.jpg', 1, 440, 465),
(9, 'business-2', 'Номер бизнес-класса с большой кроватью (King Size) и доступом в бар-гостиную', 'img/2_rooms/bz-2.jpg', 1, 390, 415),
(10, 'business-3', 'Номер бизнес-класса с двумя односпальными кроватями и доступом в бар-гостиную', 'img/2_rooms/bz-3.jpg', 2, 390, 415);
...
--
-- AUTO_INCREMENT для таблицы `roomsInfo`
--
ALTER TABLE `roomsInfo`
